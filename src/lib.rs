pub mod crypto {
    ...
    pub fn authenticate_key() -> String {
        // get passphrase
    ...
    pub fn encrypt_message(msg: &str, passphrase: &str) -> Vec<u8> {
    ...
    pub fn decrypt_message(mut msg: Vec<u8>, passphrase: &str) -> Result<String, openssl::error::ErrorStack> {
            ...
            Ok(_) => {
                match verify_message(msg, signature) {
                    ...
                    Err(_) => {
                        ...
                        msg.push_str("      ******unable to verify legitimate sender of message");
                        Ok(msg)
                    }
                }
            },
    ...
    pub fn sign_message(msg: &Vec<u8>, passphrase: &str) -> Vec<u8> {
